  ...
  return (
    ...
    <div className='Activities'>
      ...
      <div className='flex flex-col text-black text-center bg-white'> {/** TESTING */}
        <h1 className='text-[#3EB489] md:text-4xl sm:text-3xl text-2xl font-bold mt-10 mb-2'>Activity</h1>
        <div className='md:text-base text-sm my-1 md:my-2 lg:mx-14 mx-6 text-justify'>
          <p className='text-center italic font-medium text-gray-400'>The consolidation of your funds from both bank and non-bank wallets</p>
        </div>
