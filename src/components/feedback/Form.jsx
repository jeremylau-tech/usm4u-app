        ...
        <div className='lg:mx-0 mx-8 md:px-10 px-4 md:py-10 py-5 bg-slate-200 md:rounded-3xl rounded-2xl'>
          <form>
            ...
            <label className='block mb-7 mx-4 text-sm'>
              ...
              <input className='p-3 flex w-full h-10 rounded-lg text-black' type='text' id='name' name='name' placeholder='Name' required />
            </label>
            <label className='block mb-7 mx-4 text-sm'>
              <span className='block font-medium text-slate-700 my-[0.3rem] mx-1'>Student Email</span>
              <input className='p-3 flex w-full h-10 rounded-lg text-black' type='email' id='studEmail' name='studentEmail' placeholder='@student.usm.my' required />
            </label>
            <label className='block mb-7 mx-4 text-sm'>
              <span className='block font-medium text-slate-700 my-[0.3rem] mx-1'>Phone Number</span>
              <input className='p-3 flex w-full h-10 rounded-lg text-black' type='text' id='phoneNum' name='phoneNumber' placeholder='60123456789' required />
            </label>
            <label className='block mb-7 mx-4 text-sm'>
              <span className='block font-medium text-slate-700 my-[0.3rem] mx-1'>Message</span>
              <textarea className='p-3 flex w-full h-10 rounded-lg text-black max-h-[250px]' type='text' id='message' name='message' placeholder='Leave your message here' required />
            </label>
