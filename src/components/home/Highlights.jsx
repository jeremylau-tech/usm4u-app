...
function Highlights() {
  return (
    <div className='w-full py-[80px] px-4 bg-black'>
      <div>
        <h1 className='text-[#F68B1F] md:text-3xl sm:text-2xl text-xl font-bold text-center'>Highlights @ USM</h1>
      </div>
      <div className='max-w-[1240px] mx-8 md:mx-auto grid md:grid-cols-4 gap-2 md:gap-8 pt-6'>
