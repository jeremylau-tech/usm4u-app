  ...
  return (
    <div className='flex justify-between items-center h-[90px] max-w-[1240px] mx-auto px-4 text-white'>
      ...
      <ul className='hidden lg:flex'> {/** hidden on mobile devices, above mb: flex */}
        ...
        <button className='bg-[#F68B1F] w-[110px] h-[45px] font-medium rounded-lg mx-auto my-auto ml-6 content-center text-black hover:scale-105 duration-300'><a href='/Login' className=''>Log In</a></button>
      </ul>
      ...
      <div className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' : 'fixed left-[-100%]'}>
        ...
        <div className='mx-7'>
          <button className='bg-[#F68B1F] w-[110px] h-[45px] font-medium rounded-lg mx-auto my-auto mt-14 content-center text-black hover:scale-105 duration-300'><a href='/Login' className=''>Log In</a></button>
        </div>
      </div>
    </div>
  )
